...
import com.gmf.log.strategy.LogcatLogStrategy;
 ...
 * <h3>Customize</h3>
 * <pre><code>
 *   FormatDecorator formatStrategy = PrettyFormatDecorator.newBuilder()
 ...
 * </code></pre>
 */
public class PrettyFormatDecorator implements FormatDecorator {
    ...
    private PrettyFormatDecorator(@NonNull Builder builder) {
...
//            logDivider(logType, tag);
    ...
    public static class Builder {
        ...
        @NonNull
        public PrettyFormatDecorator build() {
            if (logStrategy == null) {
                logStrategy = new LogcatLogStrategy();
            }
            return new PrettyFormatDecorator(this);
        }
    }
}
